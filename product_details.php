        ...
        <div class="ps-lg-3">
         ...
         <?php echo $product['product_name']; ?>
          ...
          <div class="d-flex flex-row my-3">
            ...
            <span class="text-muted"><i class="fas fa-shopping-basket fa-sm mx-1"></i><?php echo $product['quantity']; ?></span>
      ...
      <div class="col-lg-8 mb-4">
        <div class="border rounded-2 px-3 py-2 bg-white">
          ...
          <ul class="nav nav-pills nav-justified mb-3" id="ex1" role="tablist">
            ...
            <li class="nav-item d-flex" role="presentation">
              <a class="nav-link d-flex align-items-center justify-content-center w-100" id="ex1-tab-3" data-mdb-toggle="pill" href="#ex1-pills-3" role="tab" aria-controls="ex1-pills-3" aria-selected="true">Shipping info</a>
            </li>
            <li class="nav-item d-flex" role="presentation">
